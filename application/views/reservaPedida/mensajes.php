  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('reservasPedidas');?>">Editar</a></li>
        ...
        <!-- MENSAJES  -->
          ...
          <div class="box-footer box-comments">
            ...
            <div class="box-footer">
              <form action="<?= base_url('reservasPedidas/saveMensaje');?>" method="post">
                  <input type="text" class="form-control input-sm" placeholder="Responder preguntas de los clientes" name="texto">
