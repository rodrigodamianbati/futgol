...
<head>
  ...
  <script src="<?= base_url(); ?>resources/components/jquery/dist/jquery.min.js"></script>
   ...
   <!-- Fine Uploader New/Modern CSS file
    ====================================================================== -->
    <link href="<?= base_url(); ?>fine-uploader/fine-uploader-new.css" rel="stylesheet">

    <!-- Fine Uploader jQuery JS file
    ====================================================================== -->
    <script src="<?= base_url(); ?>fine-uploader/jquery.fine-uploader.js"></script>
    ...
    <script type="text/template" id="qq-template-manual-trigger">
        <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="">
            ...
            <span class="qq-drop-processing-selector qq-drop-processing">
                <span>Procesando imagenes seleccionadas...</span>
