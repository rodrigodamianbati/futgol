		...
		<aside id="colorlib-hero" style="height: 200px; overflow-y:hidden;">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(<?= base_url(); ?>/tour/images/cover-img-4.jpg);">
			   	</li>
			  	</ul>
		  	</div>
		</aside>
					...
					<div class="col-md-8">
						<div class="wrap-division">
							<article class="animate-box">
								<?php if (count($this->session->datos->imagenes)>0){?>
								<div class="blog-img" >
									<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
										...
										<div class="carousel-inner" role="listbox">
											<?php $i = 1; foreach ($this->session->datos->imagenes as $imagen): ?>
											<?php if($i == 1){ ?>
											<div class="item active">
											<?php } else { ?>
											<div class="item ">
											<?php }?>
												<img src="<?= base_url(); ?>/uploads/<?= $imagen->nombre?>" alt="...">
								...
								<?php } ?>
								<div class="desc">
									<h2><?= $this->session->datos->alojamiento->nombre?></h2>
									<div class="meta">
										<p><?= $this->session->datos->tipo_alojamiento?> para <?=$this->session->datos->alojamiento->plazas?> <?=($this->session->datos->alojamiento->plazas>1)?'personas':'persona'?></p>
										<p>
											<span><?=$this->session->datos->alojamiento->direccion?>, <?=$this->session->datos->ciudad->nombre?>, <?= $this->session->datos->ciudad->pais?>.</span>
										</p>
									</div>
									<h3>
									<span class="label label-default">Precio por <?= $this->session->datos->noches?> <?=($this->session->datos->noches>1)?'noches':'noche'?>: </span>
									<span class="label label-success"><b>$<?= $this->session->datos->total?></b></span>
									</h3>
									<p>
									Desde el <?= date("d/m/Y", strtotime($this->session->datos->desde));?> hasta el <?= date("d/m/Y", strtotime($this->session->datos->hasta));?>.
									</p>
									<?php if($this->session->datos->c->cantidad>0){?>
									<p><span><i class="fa fa-star"></i></span> Ubicación: <?= number_format($this->session->datos->u->ubicacion,1) ?></p>
									<p><span><i class="fa fa-star"></i></span> Precio-Calidad: <?= number_format($this->session->datos->p->precio_calidad,1) ?></p>
									<p><span><i class="fa fa-star"></i></span> Limpieza: <?= number_format($this->session->datos->l->limpieza,1) ?></p>
									<?php } ?>
									
									<p><?= $this->session->datos->alojamiento->descripcion?></p>
												
									<?php if (count($this->session->datos->servicios)>0){?>
									<h4>Servicios</h4>
									<div class="row contact-info-wrap">
										<?php foreach ($this->session->datos->servicios as $servicio): ?>
										<div class="col-md-4">
