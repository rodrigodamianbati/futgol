                  ...
                  <tr>
                   <td><?php echo $cancha->nombre; ?></td>
                    ...
                    <td>
                      ...
                      <a href="<?= base_url('turnos/porcancha/'.$cancha->id); ?>" title="Ir a turnos" class="btn btn-xs" role="button"><span class="glyphicon glyphicon-picture" aria-hidden="true"></span></a>
